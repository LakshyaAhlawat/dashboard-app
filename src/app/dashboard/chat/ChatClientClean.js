        ...
        <div className="flex flex-1 flex-col">
          <div className="flex items-center justify-between border-b border-slate-800 px-4 py-3 text-xs text-slate-400">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="hidden rounded-full bg-slate-900 px-2 py-0.5 text-[10px] sm:inline-flex">
                Live · Typing-ready
              </span>
            </div>
          </div>
          ...
          <div className="flex-1 space-y-3 overflow-y-auto px-3 py-3 sm:px-4 sm:py-4">
            {messages.map((message) => {
              ...
              return (
                ...
                >
                  <div
                    className={`max-w-[75%] rounded-2xl px-3 py-2 text-xs sm:max-w-[60%] sm:px-3.5 sm:py-2.5 sm:text-sm ${
                      fromMe
                    ...
                    {message.attachment && message.attachment.type === "file" && (
                      (() => {
                        ...
                        return (
                          ...
                          >
                            <span className="h-1.5 w-1.5 rounded-full bg-sky-400" />
                            <span>{message.attachment.name || "Download attachment"}</span>
                          </a>
                        );
                      })()
                    )}
                          ...
                          {activeReactionEmojis.map((emoji) => {
                            ...
                            return (
                              <span key={emoji} className="flex items-center gap-0.5">
                                <span>{emoji}</span>
                                {count > 1 && <span className="text-[9px] text-slate-300">{count}</span>}
                              </span>
                            );
                          })}
                        </div>
          ...
          <form
            onSubmit={handleSend}
            className="flex items-center gap-2 border-t border-slate-800 bg-slate-950/90 px-3 py-2.5 sm:px-4"
          >
            ...
            <input
              ...
              className="flex-1 rounded-full border border-slate-800 bg-slate-900/80 px-3 py-2 text-xs text-slate-100 outline-none placeholder:text-slate-500 focus:border-sky-500 focus:ring-1 focus:ring-sky-500 sm:text-sm"
            />
            <button
              type="submit"
              className="inline-flex items-center justify-center rounded-full bg-sky-500 px-3 py-2 text-xs font-medium text-white shadow-md shadow-sky-500/40 hover:bg-sky-400 sm:px-4 sm:text-sm"
            >
              Send
            </button>
          </form>
